...
├── v2.html            # Version 2.0 (blob detection stable)
├── v3.html            # Version 3.0 (+ calibrage spatial)
├── v4.html            # Version 4.0 (+ zoom optique + boussole) ⭐ RECOMMANDÉE
...
- Sur téléphone faible, v3.0 peut être plus rapide
